...
if (count($_POST) > 0) {
	...
	header("location: list.php");//El header lo que hace es una cabecera en el protocolo http pero existen unas acabeceeas  
									//esas cabeceras van asociadas 
									//	a una peticion aqui php t fuerza a enviuar una vcabecera de ese 
											//estilo la de location lo que hace es mandarla a otra pagina
}
$id = isset($_GET['id']) ? $_GET['id'] : null;
$client = $cartera->getClient($id);//saca informacion del cliente
