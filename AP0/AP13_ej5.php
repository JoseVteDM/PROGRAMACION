...
/*EJERCICIO 5.- Crea una script que calcule el porcentaje de perros que tienen sobre-peso de una clínica veterinaria.
 Para ello tenemos un array con los datos de edad y peso en el archivo adjunto AP13_ej5.php.
...
Para ello, debes crear una función llamada sobrePeso, a la que le pasaremos el nombre del perro, y el array de datos por referencia, 
y devolverá true o false para señalar si tiene sobre-peso o no.

Crea una función adicional llamada edadHumana, que tomará como parámetro de entrada la edad del perro, 
y devuelve su equivalente en años humanos. Para realizar este cálculo, usa la fórmula matemática:

//Depende del tamaño de la raza de perro pueden equivaler de 4 a 8 años humanos, así que vamos a establecer que un año perruno equivale 
//a 6 años humanos
